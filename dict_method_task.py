...
##print the titles of all products.
for  i in data["products"]:
    print( i["title"])
    
    
##print the titles of products with a rating greater than 4
for  i in data["products"]:
    if i["rating"]>4:
        print(i["title"])
        
        
## Print the titles of all products in the "groceries" category.
for  i in data["products"]:
    if i["category"]=="groceries":
        print(i["title"])
        

##  Count how many products are currently marked as "In Stock".
count=0
for  i in data["products"]:
    print(i["title"], ":--available stock --:", i["stock"])
    count+=i["stock"]
print("total items in stock", count)



##  print the titles of products that have a discount greater than 15% and a rating above 4.
count=0
for  i in data["products"]:
    if i["discountPercentage"]>=15:
        print(i["title"])
        
        
        
##  Print the titles of products that have more than 2 reviews.
for  i in data["products"]:
    if len(i["reviews"])>2:
        print(i["title"])
        
        
##  Print the titles of products whose weight is greater than 5 and stock is less than 50.
for  i in data["products"]:
    if i["weight"]>=5 and i["stock"]<50:
        print(i["title"])
        
        
        
##  Calculate and print the total stock available across all products
count=0
for  i in data["products"]:
    count+=i["stock"]
print(count,"total stock available across all products")



##  print the titles of products where the average rating from reviews is less than the product’s main rating
count=0
for  i in data["products"]:
    count+=i["rating"]/len(i)
    # print(len(i["rating"]))
rating=count
print(rating)
for  i in data["products"]:
...
##  Print the titles of products where the minimum order quantity is greater than the available stock.
user=int(input("enter number   :"))
for  i in data["products"]:
    if i["stock"]>=user:
        print(i["title"],"available stock is   :",i["stock"],"---and your ordered total items--",user,"available ")
    else:
        print(i["title"],"available stock is   :",i["stock"],"---and your ordered total itmes--",user," not availableavailable ")
